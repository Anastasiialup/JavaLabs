...
public class Game {
    public static void main(String[] args) {
        ...
        schoolarTeam.playWith(schoolarTeam2);  // Гра між школярами
        // schoolarTeam.playWith(employeeTeam); // Це викличе помилку, оскільки команди з різних типів
    }
}
